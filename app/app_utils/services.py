...
DEFAULT_MEMORY_BANK_ID = "3030005006766964736"
...
def get_memory_service():
    ...
    uri = os.environ.get("MEMORY_SERVICE_URI")
    if uri and not uri.startswith("shared://"):
    ...
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-03-6800ece3e043")
    location = os.environ.get("GOOGLE_CLOUD_LOCATION", "us-central1")
    agent_engine_id = os.environ.get("MEMORY_BANK_ID", DEFAULT_MEMORY_BANK_ID)
